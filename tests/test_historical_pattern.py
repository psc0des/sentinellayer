...
class TestHistoricalPatternAgent:
    ...
    async def test_returns_historical_result_model(self, agent):
    ...
    async def test_result_fields_are_correct_types(self, agent):
    ...
    async def test_unknown_resource_type_scores_zero(self, agent):
    ...
    async def test_no_match_reasoning_says_no_history(self, agent):
    ...
    async def test_restart_payment_api_finds_critical_incident(self, agent):
    ...
    async def test_restart_payment_api_scores_maximum(self, agent):
    ...
    async def test_modify_nsg_east_finds_security_incident(self, agent):
    ...
    async def test_modify_nsg_east_scores_maximum(self, agent):
    ...
    async def test_delete_vm23_finds_dr_incident(self, agent):
    ...
    async def test_delete_vm23_scores_above_60(self, agent):
    ...
    async def test_scale_down_aks_finds_traffic_incident(self, agent):
    ...
    async def test_scale_down_aks_scores_high(self, agent):
    ...
    async def test_scale_up_vm_finds_successful_precedent(self, agent):
    ...
    async def test_scale_up_vm_scores_low(self, agent):
    ...
    async def test_update_config_sql_finds_credential_incident(self, agent):
    ...
    async def test_most_relevant_incident_is_highest_similarity(self, agent):
    ...
    async def test_recommended_procedure_comes_from_top_incident_lesson(self, agent):
    ...
    async def test_most_relevant_is_none_when_no_matches(self, agent):
    ...
    async def test_all_similar_incidents_have_similarity_score(self, agent):
    ...
    async def test_similar_incidents_sorted_by_similarity_descending(self, agent):
    ...
    async def test_similar_incident_fields_are_populated(self, agent):
    ...
    async def test_reasoning_mentions_incident_id_when_match_found(self, agent):
    ...
    async def test_reasoning_mentions_count_of_similar_incidents(self, agent):
    ...
    async def test_action_type_contributes_0_40(self, agent):
    ...
    async def test_resource_type_match_contributes_0_30(self, agent):
    ...
    async def test_resource_name_match_contributes_0_20(self, agent):
    ...
    async def test_tag_match_contributes_0_10(self, agent):
    ...
    async def test_full_match_similarity_is_1_0(self, agent):
    ...
    async def test_no_match_similarity_is_0(self, agent):
    ...
    async def test_resource_lookup_with_full_azure_id(self, agent):
    ...
    async def test_custom_incidents_path(self, tmp_path):
