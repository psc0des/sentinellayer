...
## 7. Post-QA Fix Log (2026-04-30)

### Round 2 Verification Report Fixes

| Bug | Status | Fix |
|---|---|---|
| #14 | ✅ Fixed | Docker image rebuilt from latest code — `query_resources_async` now present in production container |
| #22 | ✅ Fixed | Added 6-second debounce for alert badge decreases in `App.jsx` — single-poll-cycle dips no longer flash in sidebar |
| #23 | ✅ Fixed | Added `Export CSV` button to `ScanHistoryTable.jsx` — all 13 analytics columns exported from the Agents page Scan History table |

All fixes deployed to production: `https://gentle-water-02128160f.7.azurestaticapps.net`  
Backend image (BUG #14): rebuilt `2026-04-30`, digest `sha256:ab0cd11b7e92a`

*Round 2 fixes by Claude Sonnet 4.6 — 2026-04-30*
