...
- Plain-English explanation generated by GPT-4.1 (or a template in mock mode)
- Counterfactual analysis — "what would change this outcome?"
- Per-governance-agent reasoning
- Collapsible raw JSON audit trail

In mock mode (`USE_LOCAL_MOCKS=true`) the GPT-4.1 summary is replaced by a deterministic
